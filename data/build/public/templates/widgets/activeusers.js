    ...
    'active_users': function active_users(helpers, context, guard, iter, helper) {
      ...
      return iter(guard((context != null) ? context['active_users'] : null), function each(key0, index, length, value) {
        ...
        return "\n<a href=\"" + 
          ...
          __escape(guard((context != null && context['active_users'] != null && context['active_users'][key0] != null) ? context['active_users'][key0]['displayname'] : null)) + 
          "\">" + 
          __escape(guard((context != null && context['active_users'] != null && context['active_users'][key0] != null) ? context['active_users'][key0]['displayname'] : null)) + 
          "</div>\n<div class=\"text-xs text-muted text-truncate\">\n<span class=\"timeago\" title=\"" + 
          __escape(guard((context != null && context['active_users'] != null && context['active_users'][key0] != null) ? context['active_users'][key0]['lastposttimeISO'] : null)) + 
          "\"></span>\n</div>\n</div>\n</a>\n";
      }, function alt() {
        return "";
      });
