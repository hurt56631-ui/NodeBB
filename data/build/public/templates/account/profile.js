      ...
      return iter(guard((context != null) ? context['customUserFields'] : null), function each(key0, index, length, value) {
        ...
        return "\n" + 
          (guard((context != null && context['customUserFields'] != null && context['customUserFields'][key0] != null) ? context['customUserFields'][key0]['value'] : null) ?
            "\n<div class=\"stat\">\n<div class=\"align-items-center justify-content-center card card-header p-3 border-0 rounded-1 h-100 gap-2\">\n<span class=\"stat-label text-xs fw-semibold\"><span><i class=\"text-muted " + 
              __escape(guard((context != null && context['customUserFields'] != null && context['customUserFields'][key0] != null) ? context['customUserFields'][key0]['icon'] : null)) + 
              "\"></i> " + 
