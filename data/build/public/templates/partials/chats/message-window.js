          ...
          (guard((context != null && context['users'] != null) ? context['users']['length'] : null) ?
            "\n<div component=\"chat/user/list/btn\" class=\"btn btn-ghost btn-sm d-none d-lg-flex flex-nowrap align-items-center gap-2\" title=\"[[modules:chat.view-users-list]]\" data-bs-toggle=\"tooltip\" data-bs-placement=\"bottom\">\n<div class=\"d-flex text-nowrap\">\n" + 
              ...
              (guard((context != null && context['users'] != null) ? context['users']['2'] : null) ?
                "\n<span style=\"width: 24px; z-index: 1;\" class=\"text-decoration-none\" href=\"" + 
                  __escape(guard((context != null && context['config'] != null) ? context['config']['relative_path'] : null)) + 
                  "/user/" + 
                ...
                "") + 
              "\n</div>\n" + 
              __escape(helper(context, helpers, 'formattedNumber', [guard((context != null) ? context['userCount'] : null)])) + 
              "\n</div>\n" :
            "") + 
